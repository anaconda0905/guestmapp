...
TEMPLATE_DIR = os.path.join(BASE_DIR, "administration/templates")
TEMPLATE_DASHBOARD_DIR = os.path.join(BASE_DIR, "dashboard/templates")
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates'), TEMPLATE_DASHBOARD_DIR, TEMPLATE_DIR],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_DASHBOARD_DIR = os.path.join(BASE_DIR, "dashboard/static")
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'), STATIC_DASHBOARD_DIR, STATIC_DIR
]
